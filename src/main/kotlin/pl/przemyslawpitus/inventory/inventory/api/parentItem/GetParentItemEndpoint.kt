...
class GetParentItemEndpoint(
    private val getParentItemUseCase: GetParentItemUseCase,
    ...
    fun getItem(
        ...
        try {
            val parentItem = getParentItemUseCase.getParentItem(
...
private fun ParentItem.toGetParentItemResponse() = GetParentItemResponse(
    id = id.value,
    name = name,
